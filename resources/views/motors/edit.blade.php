    ...
    <div class="card-body">
        <form action="{{ route('motors.update', $motor) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group"><label>Berat Pengiriman (gram)</label><input type="number" name="berat_gram" class="form-control" min="1" value="{{ old('berat_gram', $motor->shipping_weight_grams) }}"><div class="field-hint">Dipakai otomatis pada form pengiriman.</div></div>
